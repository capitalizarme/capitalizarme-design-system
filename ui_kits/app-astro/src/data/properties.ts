...
// Copy specificity (UF price, cuotas, pie, plazo) mirrors source-evidence/capitalizarme-boilerplate-html/data/content.ts —
// never generic "Property 1 / Property 2" filler, per DESIGN.md §9. Same 3 listings as
// ui_kits/app-react/components/PropertyGrid.jsx.
